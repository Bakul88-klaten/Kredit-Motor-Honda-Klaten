...
export default function YamahaPage() {
  return (
    <>
      ...
      <Header />
      <main>
        {/* HERO — tulisan watermark diganti YAMAHA */}
        <section
          id="hero"
          style={{
            minHeight: '100vh',
        ...
        >
          ...
          <div className="heroContent">
            <div className="heroBadge" style={{ background: 'rgba(0,194,255,0.15)', border: '1px solid rgba(0,194,255,0.35)', color: 'rgba(255,255,255,0.9)' }}>
            ...
            <div className="heroCtas">
              <Link href="#kalkulator" className="btnPrimary" style={{ background: '#00C2FF', color: '#001a54' }}>
                Hitung Angsuran →
              </Link>
              <Link href="#produk" className="btnOutline">
                Lihat Semua Motor
              </Link>
            </div>
          </div>
        ...
        <section
          className="section"
          id="kontak"
          style={{ background: 'linear-gradient(135deg,#003087 0%,#001a54 100%)', position: 'relative', overflow: 'hidden' }}
        >
          <div className="sectionInner">
            <div className="kontakWrap">
              <div className="sectionLabel" style={{ color: 'rgba(255,255,255,0.7)' }}>Hubungi Kami</div>
              ...
              <div className="kontakCards">
                {([
                  ...
                  <div key={label} className="kontakCard">
                    ...
                    <div>
                      <div className="kontakLabel">{label}</div>
                      <div className="kontakVal">{val}</div>
                    </div>
                  </div>
                ))}
              </div>
